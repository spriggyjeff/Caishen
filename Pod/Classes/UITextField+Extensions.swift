...
internal extension UITextField {
    ...
    /**
     ...
     Therefor, this character is inserted into empty text fields and as soon as the user hits backspace, the character gets deleted. This causes `text.count` to become 0, which is used as condition to go to the previous text field.
